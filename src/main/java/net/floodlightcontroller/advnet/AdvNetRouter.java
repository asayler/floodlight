...
public class AdvNetRouter implements IFloodlightModule, IOFMessageListener {
	...
	protected static final MACAddress host1 = MACAddress.valueOf("00:00:00:00:00:01");
	protected static final MACAddress PX = MACAddress.valueOf("00:00:00:00:00:02");
	protected static final MACAddress host3 = MACAddress.valueOf("00:00:00:00:00:03");
	protected static final MACAddress host4 = MACAddress.valueOf("00:00:00:00:00:04");
	...
	{
		_log.info("Packet received - Processing!");
	...
	getCommMode(MACAddress src, MACAddress dst)
	{
		...
		// Hosts 1 and 3 allowed to communicate by proxy (Should be MAC Address 00:00:00:00:00:02)
		if (src.equals(host1) && dst.equals(host3)) {
			_log.info("Host 1 trying to connect to Host 3...");
			return RouteMode.ROUTE_PROXY;
		// Hosts 1 and 4 are not allowed to communicate at all (Send a ROUTE_DROP)
		} else { 
			if (src.equals(host1) && dst.equals(host4)) {
				_log.info("Host 1 trying to connect to Host 4...");
